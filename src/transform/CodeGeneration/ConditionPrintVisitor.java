 ...
 * 
 */
public class ConditionPrintVisitor extends FormalPathPrintVisitor {
	 ...
	 */
	public ConditionPrintVisitor(String fileName, boolean debug)
			throws CompilationException {
	...
	public Object visitVarDeclAST(VarDeclAST ast, Object o)
			throws CompilationException {
		/*
		 * this.indentString(); if (ast.t instanceof ArrayTypeAST) {
		 * ast.t.visit(this, ast.id.getText()); return null; } //
		 * ast.t.visit(this, o); not print type in path if (ast.init != null) {
		 * this.get_EM().printout("("); this.get_EM().printout("= ");
		 * this.get_EM().printout(ast.id.getText());
		 * this.get_EM().printout(" "); ast.init.visit(this, o);
		 * this.get_EM().printout(")"); }
		 */
		return null;
	}
